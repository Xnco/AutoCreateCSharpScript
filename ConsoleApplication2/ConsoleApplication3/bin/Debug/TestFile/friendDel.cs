...
public class friendDel : PackageBase
{
    ...
    public override byte[] Create()
    {
        ...
        buf.Add((byte)(friendIndex & (short)filter));
        buf.Add((byte)((friendIndex >> 8) & (short)filter));
        buf.Add((byte)((friendIndex >> 16) & (short)filter));
        buf.Add((byte)((friendIndex >> 24) & (short)filter));
