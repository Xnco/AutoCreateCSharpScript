...
public class mailRead : PackageBase
{
    ...
    public override byte[] Create()
    {
        ...
        buf.Add((byte)(checkNum & (short)filter));
        buf.Add((byte)((checkNum >> 8) & (short)filter));
        buf.Add((byte)((checkNum >> 16) & (short)filter));
        buf.Add((byte)((checkNum >> 24) & (short)filter));
